...
//
// console.log(`luis tiene 20 años y juega ${juegos[1]}`);
// console.log(alumnos[0],"tiene",  notas[0],"en programacion y", juegos[0]);




// let calcularPotencia= (num1, num2) => {
//     const pot1=num1*num1;
//     const pot2=num2*num2;   
//     return `${pot1} y ${pot2}`;
// };

// //No es necesario usar paréntesis en el return
...
//     r1=num1*num1;
//     r2=num2*num2;
//     return console.log("el resultado de los cuadrados es:" + r1  + r2); 
// }
//* Tipos de datos
/**
 * * string
...
let saludar =(nombre, apellido, edad)=> {
    ...
    return `Hola ${nombre} ${apellido} , tienes ${edad} años, mucho gusto.`
...
let calcularArea =(base, altura)=> {
    return `Área del rectángulo es: ${+base * +altura} `;
};


const valores= [1,2,3,4,5,6];
let preguntarArreglo=(valores)=> {
    return valores.length> 5 ? "Arreglo grande" : "Arreglo pequeño";
};